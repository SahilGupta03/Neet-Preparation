...
public class OnethreeActivity extends AppCompatActivity {
...
String message,message1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aiims=findViewById(R.id.aiiMs13);
        aipmt=findViewById(R.id.aiPmt13);

        // aiims
        database= FirebaseDatabase.getInstance().getReference().child("2013").child("Aiims");
        database.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(OnethreeActivity.this, "Error Loading PDF", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        // aipmt
        database= FirebaseDatabase.getInstance().getReference().child("2013").child("Aipmt");
        database.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
