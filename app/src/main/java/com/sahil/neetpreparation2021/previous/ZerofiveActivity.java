...
public class ZerofiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zerofive);

        aipmt=findViewById(R.id.aiPmt2005);
        aiims=findViewById(R.id.aiiMs2005);


        // aiims
        database= FirebaseDatabase.getInstance().getReference().child("2005").child("Aiims");
        database.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ZerofiveActivity.this, "Error Loading PDF", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        // aipmt
        database= FirebaseDatabase.getInstance().getReference().child("2005").child("Aipmt");
        database.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
